...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM auditoria_acoes WHERE auditoria_acao = 'inclusao' AND auditoria_tela = 'Cadastro de Servidor de Backup' ORDER BY auditoria_data_hora DESC");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Registro de Ações - Tela Cadastro de Servidor de Backup</h3>
