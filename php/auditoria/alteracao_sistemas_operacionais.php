...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM auditoria_acoes WHERE auditoria_acao = 'alteracao' AND auditoria_tela = 'Alteração de Sistemas Operacionais' ORDER BY auditoria_usuario");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Registro de Ações - Tela Alteração de Sistemas Operacionais</h3>
