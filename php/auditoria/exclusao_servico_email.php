...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM auditoria_acoes WHERE auditoria_acao = 'exclusao' AND auditoria_tela = 'Cadastro de Serviço de Envio de Email' ORDER BY auditoria_data_hora DESC");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Registro de Ações - Tela Exclusão de Serviço de Email</h3>
