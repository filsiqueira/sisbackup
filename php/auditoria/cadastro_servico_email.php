...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM auditoria_acoes WHERE auditoria_acao = 'inclusao' AND auditoria_tela = 'Cadastro de Serviço de Envio de Email' ORDER BY auditoria_usuario");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Registro de Ações - Tela Cadastro de Email</h3>
