...
$conexao = conectar();
$sql = $conexao->prepare("SELECT * FROM auditoria_acoes WHERE auditoria_acao = 'exclusao' AND auditoria_tela = 'Exclusão de Sistemas Operacionais' ORDER BY auditoria_data_hora DESC");
$sql->execute();
?>
<div class="container">
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Registro de Ações - Tela Exclusão de Sistemas Operacionais</h3>
