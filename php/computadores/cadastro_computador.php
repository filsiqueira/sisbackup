        ...
        <div class="col-xs-12 col-sm-8" style="margin-left:210px;">
            <div class="widget-box">
                <div class="widget-header">
                    ...
                    <span style="margin-left:72%" class="help-button" data-rel="popover" data-trigger="hover" data-placement="bottom" title="OBS: Compartilhe o disco com nome de 'HD' ">?</span>                </div>
                <div class="widget-body">
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4">
                            ...
                            <select id="sistema_operacional_id" class="chosen-select form-control" onchange="retorna_doc_a_partir_do_so()">
                    ...
                    <hr>
                      ...
                      <div class="form-group col-md-6">
                          ...
                          <select multiple="" class="chosen-select form-control" id='documento_id' data-placeholder="Selecione">
                          </select>
                        </div>
                        <div class="form-group col-md-6">
                          <label data-rel="popover" data-trigger="hover" data-placement="bottom" title="Senha do usuário com permissão no compartilhamento 'HD' deste computador">Não copiar Arquivos com as seguintes extensões</label>
                      ...
                      <hr>
                    <center>
                        <button type="button" class="btn btn-primary" onclick="cadastrar_computador()" id="cadastrar_computador">CADASTRAR</button>
